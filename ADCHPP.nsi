...
InstallDir "$PROGRAMFILES64\ADCH++"
...
Section "MainSection" SEC01
  ...
  File "readme.txt"
  File "changelog-iceman50.txt"
  File "FirstReg.cmd"
  File "Generate_certs.cmd"
  File "Generate_certs.ps1"
  ...
  File "config\HBRI.xml"
  File "config\RTF0.xml"
  File "config\BBS0.xml"
SectionEnd
...
Section -un.remSettings
  ...
  Delete "$INSTDIR\config\about.txt"
  Delete "$INSTDIR\config\rules.txt"
  ...
  Delete "$INSTDIR\config\about.txt.tmp"
  Delete "$INSTDIR\config\rules.txt.tmp"
  ...
  Delete "$INSTDIR\config\HBRI.xml"
  Delete "$INSTDIR\config\RTF0.xml"
  Delete "$INSTDIR\config\BBS0.xml"
...
Section Uninstall
  ...
  Delete "$INSTDIR\BBS0.dll"
  Delete "$INSTDIR\HBRI.dll"
  ...
  Delete "$INSTDIR\Scripts\texts.lua"
