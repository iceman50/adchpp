...
== Optional cross-platform configuration UI

The standalone PyQt6 configuration manager supports initial setup, core and
listener settings, registered users, and plugin configuration. It is installed
and run independently, so the normal ADCH++ build has no Python or Qt
dependency. See `adchpp-ui/README.md` for setup and usage details.
